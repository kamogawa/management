          ...
          <DialogContent>
            ...
            <label htmlFor='raised-button-file'>
              <Button variant="contained" color='primary' component='span' name='file'>
                {this.state.fileName === "" ? "プロフィール画像" : this.state.fileName }
              </Button>
            </label>
            <br/>
            <TextField label='お名前' type="text" name='userName' value={this.state.userName} onChange={this.handleValueChange} /><br/>
            <TextField label='誕生日' type="text" name='birthday' value={this.state.birthday} onChange={this.handleValueChange} /><br/>
